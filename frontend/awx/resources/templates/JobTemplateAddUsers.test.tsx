...
import { JobTemplateAddUsers } from './JobTemplateAddUsers';
...
describe('JobTemplateAddUsers', () => {
  it('should render wizard with Select user(s) step', { timeout: 15000 }, async () => {
    render(
      <MemoryRouter initialEntries={['/templates/job-template/1/user-access/add']}>
        <Routes>
          <Route
            path="/templates/job-template/:id/user-access/add"
