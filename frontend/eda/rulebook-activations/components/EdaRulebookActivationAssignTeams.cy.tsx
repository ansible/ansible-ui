...
describe('EdaRulebookActivationAssignTeams', () => {
  const component = <EdaRulebookActivationAssignTeams />;
  const path = '/activations/:id/team-access/assign-teams';
  const initialEntries = [`/activations/1/team-access/assign-teams`];
  const params = {
    path,
    initialEntries,
  };
