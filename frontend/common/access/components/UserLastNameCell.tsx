...
export function UserLastNameCell(props: { userAccess?: UserRoleAccess }) {
  ...
  const lastName = data?.results && data.results?.length > 0 ? data.results[0]?.last_name : '';
  return <TextCell text={lastName} />;
}
