...
baseConfig.e2e!.excludeSpecPattern = [
  ...
  'cypress/e2e/eda/Access-Management/team-access.cy.ts',
  'cypress/e2e/eda/Access-Management/user-access.cy.ts',
  'cypress/e2e/eda/Access-Management/team-roles-tab.cy.ts',
