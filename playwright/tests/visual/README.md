...
> **Note:** The `--update-snapshots` flag can be combined with an AAP version: `/run-aap-ui-playwright 2.6-next --update-snapshots`
...
1. **Main content screenshot** — captures the main content area (`.pf-v6-c-page__main`), excluding sidebar and brand logo for upstream compatibility
