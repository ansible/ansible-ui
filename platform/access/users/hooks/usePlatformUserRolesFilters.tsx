...
export function usePlatformUserRolesFilters(
    ...
    const filters: IToolbarFilter[] = [
      {
        ...
        query: 'content_type__service',
        options: [
          { value: 'awx', label: getDisplayName('awx', { isTitleCase: true }) },
          { value: 'eda', label: getDisplayName('eda', { isTitleCase: true }) },
          { value: 'galaxy', label: getDisplayName('galaxy', { isTitleCase: true }) },
          { value: 'shared', label: getDisplayName('shared', { isTitleCase: true }) },
        ],
      },
    ];
