...
import {
  PromptFormValues,
  ScheduleWizardFormValues,
  WizardFormValues,
  WorkflowVisualizerWizardFormValues,
} from './types';

export function PromptedFieldsStep<
  T extends ScheduleWizardFormValues | WorkflowVisualizerWizardFormValues,
>() {
