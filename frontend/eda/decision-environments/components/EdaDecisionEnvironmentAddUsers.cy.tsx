...
describe('EdaAddUsers', () => {
  const component = <EdaDecisionEnvironmentAddUsers />;
  const path = '/decision-environments/:id/user-access/add-users';
  const initialEntries = [`/decision-environments/1/user-access/add-users`];
  const params = {
    path,
    initialEntries,
  };
