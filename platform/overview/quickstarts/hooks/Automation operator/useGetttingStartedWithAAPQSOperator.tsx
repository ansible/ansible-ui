...
export function useGettingStartedWithAAPQSOperator() {
  const { t } = useTranslation();

  const qsData: QuickStart = {
    metadata: {
      name: t('getting started with Ansible Automation Platform - Ansible Operator'),
      instructional: true,
    },
    spec: {
      displayName: t('Getting started with Ansible Automation Platform - Ansible Operator'),
      durationMinutes: 20,
      type: {
        text: t('Automation operator'),
        color: 'grey',
      },
      ...
      introduction: t('Get started with Ansible Automation Platform as an automation operator.'),
      tasks: [
        {
          title: t('Get started with playbooks'),
          description: t(
        ...
        {
          title: t('Create a plugin (optional)'),
          description: t(
