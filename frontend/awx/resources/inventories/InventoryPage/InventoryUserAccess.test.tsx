...
import { InventoryUserAccess } from './InventoryUserAccess';
...
describe('InventoryUserAccess', () => {
  it('should render user access view with alert', async () => {
    render(
      <MemoryRouter initialEntries={['/inventories/1/user-access']}>
        <Routes>
          <Route path="/inventories/:id/user-access" element={<InventoryUserAccess />} />
        </Routes>
      </MemoryRouter>
    );
