export enum HubRoute {
  ...
  RepositoryRemoveCollectionVersion = 'hub-repository-page-remove-collection-version',
  RepositoryAddCollectionVersion = 'hub-repository-page-add-collection-version',
