...
export function PlatformRoleAssignmentsReviewStep(props: {
...
>(props: ReviewExpandableListProps<K>) {
  ...
  const labelForSelectedItems = useMemo(() => {
    ...
    switch (fieldName) {
      ...
      case 'resources':
        return t('Resources');
      case 'edaRoles':
        return edaRolesLabel || t('Organization roles');
      case 'awxRoles':
        return awxRolesLabel || t('Organization roles');
      case 'hubRoles':
        return hubRolesLabel || t('Organization roles');
      default:
        return '';
    }
  ...
  }, [fieldName, getContentTypeComponentNames, t]);
