...
import { NotificationTeamAccess } from './NotificationTeamAccess';
...
describe('NotificationTeamAccess', () => {
  it('should render team access with Team name or Assign teams', { timeout: 10000 }, async () => {
    render(
      <MemoryRouter initialEntries={['/notification-templates/1/team-access']}>
        <Routes>
          <Route
            path="/notification-templates/:id/team-access"
