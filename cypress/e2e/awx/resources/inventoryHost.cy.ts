...
describe('Inventory Host Tab Tests', () => {
  ...
  describe('Inventory Host List Tests', () => {
    kinds.forEach((kind) => {
      ...
      if (kind === ''){
        it('can create a host from the inventory hosts tab and verify that it is associated with that inventory', () => {
        ...
        it('can edit a host in the hosts tab list of an inventory', () => {
        ...
        it('can delete a single host from the hosts list tab of an inventory', () => {
          //1) Use the inventory created in beforeEach block, access the host tab of that inventory
          //2) Use the host created in the beforeEach block
      ...
      it(`can run an ad-hoc command against a host on the inventory hosts tab (${kind === '' ? 'regular' : kind})`, () => {
        //1) Use the inventory created in beforeEach block, access the host tab of that inventory
  ...
  describe('Inventory Host Details Page Tests', () => {
    ...
    kinds.forEach((kind) => {
      ...
      if (kind === ""){
        it('can edit a host from the details screen by navigating from the host tab list of an inventory', () => {
        ...
        it('can delete a host from the details screen by navigating from the host tab list of an inventory', () => {
  ...
  describe('Inventory Host Groups Tab Tests (Only for regular inventory)', () => {
    ...
    it('can view a list of all group(s) associated with the host on the groups host tab of an inventory', () => {
    ...
    it('can associate a group to the host on the host tab of an inventory', () => {
      //1) Utilize the inventory, host, and group that were created in the beforeEach block- they are linked together
    ...
    it('can disassociate a single group from the host on the host tab of an inventory', () => {
      //1) Utilize the inventory, host, and group that were created in the beforeEach block- they are linked together
    ...
    it('can bulk disassociate multiple groups from the host on the host tab of an inventory', () => {
      //1) Utilize the inventory, host, and group that were created in the beforeEach block- they are linked together
