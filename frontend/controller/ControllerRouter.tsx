...
export function ControllerRouter() {
    return (
        <Routes>
            ...
            <Route
                path={RouteE.Credentials.replace(RouteE.Controller, '')}
                element={<Credentials />}
            />
            ...
            <Route
                path={RouteE.Inventories.replace(RouteE.Controller, '')}
                element={<Inventories />}
            />
            ...
            />
            <Route
                path={RouteE.CreateUser.replace(RouteE.Controller, '')}
                element={<CreateUser />}
            />
            ...
            <Route
                path={RouteE.TeamDetails.replace(RouteE.Controller, '')}
                element={<TeamDetails />}
            />
            ...
            <Route
                path={RouteE.ControllerDebug.replace(RouteE.Controller, '')}
                element={<Debug />}
            />
