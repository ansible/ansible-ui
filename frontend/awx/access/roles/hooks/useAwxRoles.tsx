...
export interface AwxResourceTypeRoles {
  name: string;
  roles: {
    [roleId: string]: {
      id: string;
...
export function useAwxRoles(): {
  credential: AwxResourceTypeRoles;
  job_template: AwxResourceTypeRoles;
  workflow_job_template: AwxResourceTypeRoles;
  inventory: AwxResourceTypeRoles;
  project: AwxResourceTypeRoles;
  organization: AwxResourceTypeRoles;
  team: AwxResourceTypeRoles;
  [resourceId: string]: AwxResourceTypeRoles;
} {
