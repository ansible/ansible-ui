export enum AwxRoute {
  ...
  InventorySchedulePage = 'awx-inventory-schedule-page',
  InventoryScheduleDetails = 'awx-inventory-schedule-details',
  InventoryScheduleRrules = 'awx-inventory-schedule-rrules',
