...
| Before writing or reviewing unit / component tests | `.claude/skills/testing_guidelines.md` |
| Before writing Playwright E2E | `.claude/skills/frontend-playwright-e2e/SKILL.md` |
