...
describe('EdaEventStreamAssignTeams', () => {
  const component = <EdaEventStreamAssignTeams />;
  const path = '/event-streams/:id/team-access/assign-teams';
  const initialEntries = [`/event-streams/1/team-access/assign-teams`];
  const params = {
    path,
    initialEntries,
  };
