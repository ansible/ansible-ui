...
import { useDeleteOAuthApplications } from './hooks/useDeleteOAuthApplications';
import { useOAuthApplicationColumns } from './hooks/useOAuthApplicationColumns';

export function OAuthApplicationsTable() {
  ...
  const tableColumns = useOAuthApplicationColumns();
  ...
  const deleteApplications = useDeleteOAuthApplications(view.unselectItemsAndRefresh);
