...
const AWX_SERVER = process.env.AWX_SERVER as string;
const AWX_WEBSOCKET_PREFIX = '/websocket/';

const environment: Record<string, string> = {
  AWX_SERVER,
  AWX_API_PREFIX: '/api/v2',
  AWX_WEBSOCKET_PREFIX,
};
console.log('Environment', environment);

const proxyUrl = AWX_SERVER ? new URL(AWX_SERVER) : undefined;
const wsURL = AWX_SERVER ? new URL(AWX_SERVER) : undefined;
