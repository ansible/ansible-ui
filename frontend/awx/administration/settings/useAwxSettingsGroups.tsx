    ...
    const awxGroups: IAwxSettingsGroup[] = [
      {
        ...
        description: t('Configure and manage automation controller system settings.'),
        defaultSlugs: ['system'],
        categories: [],
      },
      {
        id: 'jobs',
        name: t('Job Settings'),
        description: t('Define the operation of Jobs in automation controller.'),
        defaultSlugs: ['jobs'],
        categories: [],
      },
      {
        ...
        description: t('Set up logging to one of the supported external log aggregation services.'),
      ...
      },
      {
        ...
        description: t('Enable or disable flags to aid in debugging issues within the platform.'),
        defaultSlugs: ['debug'],
        categories: [],
      },
      {
