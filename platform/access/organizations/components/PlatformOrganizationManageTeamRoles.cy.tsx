import mockEdaOrganizations from '@ansible/cypress/fixtures/edaOrganizations.json';
import mockEdaTeams from '@ansible/cypress/fixtures/edaTeams.json';
import mockAwxOrg from '@ansible/cypress/fixtures/organization.json';
...
describe('PlatformOrganizationManageTeamRoles', () => {
  ...
  beforeEach(() => {
    ...
    cy.intercept('GET', gatewayAPI`/teams/2/`, mockPlatformTeam);
