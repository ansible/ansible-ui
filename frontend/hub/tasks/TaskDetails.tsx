...
import { Detail, DetailsList, PageBody, PageHeader, PageLayout, SinceCell } from '../../../framework'
...
export function TaskDetails() {
    ...
    return (
        <PageLayout>
            <PageHeader title={task?.name} breadcrumbs={[{ label: t('Task management'), to: RouteE.Tasks }, { label: task?.name }]} />
            <PageBody>
                <Scrollable>
                    <PageSection
                        variant="light"
