/** @deprecated Use Authentication from '@ansible/playwright/utils' instead */
...
export async function deleteAuthenticationMethod(authenticatorName: string, page: Page) {
  await navigateTo(page, 'Access Management', 'Authentication Methods');
...
export async function createAuthenticationMap(
  options: { authenticatorName: string; name?: string; trigger?: string },
  page: Page
) {
