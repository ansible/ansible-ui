...
describe('HUB Overview', () => {
  ...
  it.skip('verify that EDA collections are displayed', () => {
    cy.navigateTo('hub', 'overview');
  ...
  it.skip('verify that API request indicated a limit of 12 collections sorted by latest created timestamp', () => {
    cy.intercept(
      'GET',
  ...
  it.skip('verify that collection name links to collection details', () => {
    cy.navigateTo('hub', 'overview');
    cy.contains('div.pf-v5-c-card__header', 'Event-Driven Ansible content')
      .parent()
      .within(() => {
  ...
  it.skip('clicking on "Go to collections" opens collections UI filtered by EDA collections', () => {
    cy.navigateTo('hub', 'overview');
    cy.contains('div.pf-v5-c-card__header', 'Event-Driven Ansible content')
      .parent()
      .within(() => {
  ...
  describe('Manage view modal', () => {
    it.skip('clicking on Cog icon opens the Manage view modal', () => {
      cy.navigateTo('hub', 'overview');
    ...
    it.skip('unselecting all categories in the Manage results in an empty state UI on the dashboard', () => {
      cy.navigateTo('hub', 'overview');
      cy.clickButton('Manage view');
      cy.get('.pf-v5-c-modal-box__title-text').should('contain', 'Manage view');
    ...
    it.skip('within the Manage Dashboard modal, checking/unchecking a resource should display/hide the resource', () => {
      cy.navigateTo('hub', 'overview');
      cy.clickButton('Manage view');
      cy.contains('tr', 'Storage collections').find('input').uncheck();
      cy.clickModalButton('Apply');
    ...
    it.skip('reordering categories within the Manage View modal should be reflected in the dashboard', () => {
